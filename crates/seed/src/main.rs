...
fn main() {
    ...
    if !json_mode {
        ...
        println!(
            "INSERT INTO thread (id, space_id, kind, title, author_id, created_at, bumped_at, \
             post_count, state, cache_version) VALUES (1, 1, 'discussion', \
    ...
    if json_mode {
        println!(
            "{{\"space\":{{\"id\":1,\"slug\":\"general\",\"name\":\"General\",\
             ...
             \"thread\":{{\"id\":1,\"space_id\":1,\"kind\":\"discussion\",\
